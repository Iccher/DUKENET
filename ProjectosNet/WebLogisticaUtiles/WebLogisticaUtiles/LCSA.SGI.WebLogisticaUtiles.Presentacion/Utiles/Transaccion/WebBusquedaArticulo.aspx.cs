...
namespace LCSA.SGI.WebLogisticaUtiles.Presentacion.Utiles.Transaccion
{
    public partial class WebBusquedaArticulo : System.Web.UI.Page
    {
        ...
        /*Colocado WEBSERVICE*/
        ServiceUtiles.UtilesClient ServUtiles = new ServiceUtiles.UtilesClient();
        ServiceReference1.AlmacenOperacionesWSClient objSerJava = new ServiceReference1.AlmacenOperacionesWSClient();
        /****/
