...
Public Class TControlVB
    ...
    Public Sub DataTableToExcel(ByVal pDataTable As DataTable)
        ...
        Dim vFileName As String = "C:\PRUEBASOFFICE\xxx.xls"
    ...
    Public Sub DataTableToExcelDATAVIEW(ByVal pDataTable As DataView)
        ...
        Dim sb As String
        Dim dc As DataColumn
        For Each dc In pDataTable.Table.Columns
            sb &= dc.Caption & Microsoft.VisualBasic.ControlChars.Tab
        Next
        PrintLine(1, sb)
        ...
        Dim i As Integer = 0
        Dim dr As DataRow
        For Each dr In pDataTable.Table.Rows
            i = 0 : sb = ""
            For Each dc In pDataTable.Table.Columns
                If Not IsDBNull(dr(i)) Then
                    sb &= CStr(dr(i)) & Microsoft.VisualBasic.ControlChars.Tab
    ...
    Public Sub DataTableToExcelDATAGRIDVIEW(ByVal pDataTable As DataGridView)

        'Dim vFileName As String = Path.GetTempFileName()
        Dim vFileName As String = "C:\PRUEBASOFFICE\Prueba.xls"
        FileOpen(1, vFileName, OpenMode.Output)
        ...
        For c1 = 0 To pDataTable.Columns.Count - 1
            Cabecera = pDataTable.Columns(c1).Name.ToString()
            sb &= Cabecera & Microsoft.VisualBasic.ControlChars.Tab
        Next
        ...
        Dim i As Integer = 0
        Dim dr As DataRow
        For r1 = 0 To pDataTable.Rows.Count - 1
            i = 0 : sb = ""

            For c1 = 0 To pDataTable.Columns.Count - 1
                If Not IsDBNull(pDataTable(c1, r1).Value.ToString()) Then
                    sb &= CStr(pDataTable(c1, r1).Value.ToString()) & Microsoft.VisualBasic.ControlChars.Tab
                Else
                    sb &= Microsoft.VisualBasic.ControlChars.Tab
                End If
                i += 1
